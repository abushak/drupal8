 ...
 * on Thu, 30 Mar 2017 05:14:37 +0200.
 *
...
if (isset($_SERVER['db_name'])) {
  ...
  */
  ...
  $settings['file_public_path'] = 'sites/dev.test.devshop.odnodumci.com/files';
  $settings['file_private_path'] = 'sites/dev.test.devshop.odnodumci.com/private/files';
  $config['system.file']['path']['temporary'] = 'sites/dev.test.devshop.odnodumci.com/private/temp';
  $config_directories[CONFIG_SYNC_DIRECTORY] = 'sites/dev.test.devshop.odnodumci.com/private/config/sync';
  $settings['hash_salt'] = 'cJnLg8Qgf63KREaXKpnEDhrRAXkpxMtcgfyDpUe9i3u3qPCkiXuH4n6Tkac4SZEFNaFKKsqjDg';
  ...
  $settings['trusted_host_patterns'] = array(
    '^dev\.test\.devshop\.odnodumci\.com$',
    '^localhost$',
    '^localhost\.*',
    '\.local$',
  );
...
# Extra configuration from modules:
  ...
  if (is_readable('/var/aegir/projects/test/dev/sites/dev.test.devshop.odnodumci.com/local.settings.php')) {
    include_once('/var/aegir/projects/test/dev/sites/dev.test.devshop.odnodumci.com/local.settings.php');
  }
